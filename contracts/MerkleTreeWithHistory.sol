...
contract MerkleTreeWithHistory {
    ...
    uint256 public constant FIELD_SIZE = 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff;
    uint256 public constant ZERO_VALUE = uint256(keccak256("demo")) % FIELD_SIZE;
     ...
     */
    function hashLeftRight(uint256 _left, uint256 _right) public view returns (bytes32) {
